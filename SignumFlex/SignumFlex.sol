...
contract SignumFlex {
     ...
     * @param _tokenAddress address of staking token contract (flex addy needed for token deployment)
     */
    function init(address _governanceAddress, address _tokenAddress) external {
    ...
    /**
     * @dev Used during the upgrade process to verify valid Signum contracts
     * @return bool value used to verify valid Signum contracts
     */
