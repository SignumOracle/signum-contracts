...
contract Governance is UsingSignum {
    ...
    address public oracleAddress; //signumFlex address
    address public privateFactoryAddress; //private signumFlex deployer contract
    ...
    mapping(address => bool) public privateOracleAddresses; // mapping of oracle addresses for private oracles.
    ...
    event PrivateOracleAdded(address _privateOracleAddress); // Emits when a new private oracle is added to the system
    event PrivateFactoryUpdated(address _privateFactoryAddress); // Emits when a new private oracle is added to the system

    /**
     * @dev Initializes contract parameters
     * @param _signum address of signum oracle contract to be governed
     * @param _teamMultisig address of signum team multisig, one of four voting
     * stakeholder groups
     */
    constructor(
    ...
    /*
     * @dev Adds a private oracle to the mapping of privateOracleAddresses to be governed by governance.
     * @param _privateOracleAddress address of the private signum oracle contract to be governed
     */
    ...
    /*
     * @dev Updates the Factory deployer for private oracles.
     * @param _privateFactoryAddress address of the private signum factory deployer contract
     */
